Pod::Spec.new do |s|
  ...
  s.version          = '1.0.19'                   # Version (must match your Git tag)
...
#  s.source           = { :git => 'https://github.com/takephone/MGFrameworkPublic.git', :tag => '1.0.19' } 
#  s.source           = { :http => 'https://github.com/takephone/MGFrameworkPublic/releases/download/v1.0.19/MGConnectFramework-1.0.19.zip' }
  s.source           = { :git => 'https://github.com/takephone/MGFrameworkPublic.git', :tag => '1.0.19' }   # ← no 'v' here unless your tag has 'v'  
