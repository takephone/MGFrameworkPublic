Pod::Spec.new do |s|
  ...
  s.version          = '1.0.22'                   # Version (must match your Git tag)
...
#  s.source           = { :git => 'https://github.com/takephone/MGFrameworkPublic.git', :tag => '1.0.22' } 
#  s.source           = { :http => 'https://github.com/takephone/MGFrameworkPublic/releases/download/v1.0.22/MGConnectFramework-1.0.22.zip' }
  s.source           = { :git => 'https://github.com/takephone/MGFrameworkPublic.git', :tag => '1.0.22' }   # ← no 'v' here unless your tag has 'v'  
